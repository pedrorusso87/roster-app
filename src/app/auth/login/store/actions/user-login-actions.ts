...
import { UserInformation, UserRegistration } from 'src/app/models/user';
...
LoginUser | LoginUserSuccess |LoginUserFailed |
GetCurrentUser | GetCurrentUserSuccess | GetCurrentUserFailed;
